...
| Taiwan health food permit, label and approved effect wording | health_food | 9 | 8 | Confirm permit scope before allowing any health-food wording or approved-effect claim. |
...
- Term IDs: `health-food-permit`, `health-food`, `health-food-application-permit`, `health-food-approved-effect-vocabulary`, `health-food-label-required-items`, `novel-food-ingredient-safety-assessment`, `health-functional-food`, `protein-bar`
