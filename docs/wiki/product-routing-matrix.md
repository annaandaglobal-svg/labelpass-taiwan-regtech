...
- Term IDs: `food-labeling-claims`, `food-allergen-labeling`, `food-label-required-items`, `nutrition-labeling`, `potassium-glycerophosphate-food-additive`, `steviol-glycosides-food-additive`, `food-additive-functional-classes`, `benzoates-food-additives`, `caseinates-food-additives`, `sorbates-food-additives`
