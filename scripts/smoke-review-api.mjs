...
const knowledgeCases = [
  ...
  { query: "해바라기유", expectedTerm: "Edible vegetable oil (食用油脂)" },
  { query: "coconut oil", expectedTerm: "Edible vegetable oil (食用油脂)" },
  { query: "탈지분유", expectedTerm: "Milk powder (脫脂奶粉·全脂奶粉)" },
  { query: "리보플라빈", expectedTerm: "Riboflavin / Vitamin B2 (核黃素)" },
  { query: "vitamin B", expectedTerm: "Riboflavin / Vitamin B2 (核黃素)" },
  { query: "완전경화유", expectedTerm: "Partially hydrogenated oil ban / trans fat (不完全氫化油)" },
  { query: "젤라틴", expectedTerm: "Gelatin (animal-derived) 明膠" },
  { query: "아크릴아마이드", expectedTerm: "Process contaminants (3-MCPD·acrylamide)" },
  { query: "100% 주스", expectedTerm: "Juice content naming (果汁/果汁飲料)" },
  { query: "마스크", expectedTerm: "Medical device (contact lens/tampon/condom/mask)" },
  { query: "콘택트렌즈", expectedTerm: "Medical device (contact lens/tampon/condom/mask)" },
  { query: "적색2호", expectedTerm: "Synthetic food colour positive list (8 permitted)" },
  { query: "초콜릿", expectedTerm: "Chocolate naming standard (巧克力)" },
  { query: "전자담배", expectedTerm: "Tobacco / e-cigarette (電子煙 banned)" },
  { query: "치약", expectedTerm: "Toothpaste/mouthwash/soap = cosmetic" },
  { query: "펫푸드", expectedTerm: "Pet food (寵物食品 · 農業部)" },
  { query: "과산화벤조일", expectedTerm: "Benzoyl peroxide flour bleach (過氧化苯甲醯)" },
  { query: "카라기난", expectedTerm: "Carrageenan / guar gum (增稠劑)" },
  { query: "주름개선", expectedTerm: "Anti-wrinkle claim (抗皺)" },
  { query: "치즈", expectedTerm: "Yogurt / cheese (dairy)" },
  { query: "멜라민", expectedTerm: "Melamine (三聚氰胺)" },
  { query: "간장", expectedTerm: "Soy sauce (醬油) 3-MCPD" },
  { query: "소주", expectedTerm: "Soju/makgeolli/beer (酒)" },
  { query: "커피", expectedTerm: "Coffee (咖啡)" },
  ...
  { query: "화장품 GMP", expectedTerm: "Cosmetic Good Manufacturing Practice" },
  ...
  { query: "POTASSIUM GLYCEROPHOSPHATE", expectedTerm: "Potassium Glycerophosphate" },
  { query: "글리세로인산칼륨", expectedTerm: "Potassium Glycerophosphate" },
  { query: "아스퍼질러스 오리재발효분말", expectedTerm: "Aspergillus Oryzae Fermented Powder" },
  { query: "아스퍼질러스 나이거 배양물", expectedTerm: "Aspergillus Niger Culture" },
  { query: "黑麴菌培養物", expectedTerm: "Aspergillus Niger Culture" },
