-- Return enough direct source candidates for the app's requested result limit.
-- The previous RPC version returned roughly half the requested limit, which could hide
-- exact official sources behind term-boosted related sources.
