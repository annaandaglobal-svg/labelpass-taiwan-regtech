...
function baseVerdictForKnowledgeTerm(term: KnowledgeTermForVerdict): KnowledgeVerdict | null {
  ...
  if (category === "uv_filter") {
    return {
      ...
      detail:
        "자외선 차단 성분은 대만 化粧品防曬劑成分使用限制表의 인정 목록·최대 함량 이내에서만 쓸 수 있습니다: 아보벤존 5%, 옥시벤존(BP-3) 6%(0.5% 초과 시 '本產品含二苯酮-3' 표기), 옥토크릴렌 10%, 산화아연 25%, 이산화티타늄 25%. SPF/PA 표시는 시험자료 근거가 필요하고, 나노(ZnO/TiO₂ 총 25% 초과·스프레이형)는 特定用途 등록·규격 확인이 필요합니다. 제품 등록·PIF 대상입니다.",
      tone: "gold",
      state: "needs_check",
