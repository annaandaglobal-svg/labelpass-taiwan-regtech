...
function baseVerdictForKnowledgeTerm(term: KnowledgeTermForVerdict): KnowledgeVerdict | null {
  ...
  if (category === "pesticide_border_risk") {
    return {
      ...
      detail:
        "한국산 고춧가루·고추 분말(番椒屬)은 2025~2026 대만 국경검사에서 잔류농약 위반이 반복돼 반려율이 높고(克美素 chlormequat·陶斯松 chlorpyrifos·2,4-D 등), 일부 한국 업체는 1개월 수입 중단 조치를 받았습니다. 고추 함유 가공식품(고추장·라면 스프 등)도 대상이 될 수 있습니다. 선적 전 대만 농약잔류 허용기준(農藥殘留容許量標準) 대비 시험성적서를 반드시 확보하세요.",
      tone: "red",
      state: "restricted_risk",
