...
function baseVerdictForKnowledgeTerm(term: KnowledgeTermForVerdict): KnowledgeVerdict | null {
  ...
  if (category === "children_food_marketing") {
    return {
      ...
      detail:
        "지방·포화지방·나트륨·첨가당이 기준을 넘는 과자·사탕·음료·빙과 등 '어린이가 장기 섭취에 부적합한 식품'은 어린이 대상 광고·판촉이 제한됩니다(食安法 §28, 不適合兒童長期食用之食品廣告及促銷管理辦法, 2016 시행): 어린이 채널 17~21시 광고 금지, '식사 대체' 표현 금지, 어린이 대상 장난감 사은품·끼워팔기 금지. 위반 시 NT$4만~400만. 어린이 스낵·음료 마케팅에 직접 적용됩니다.",
      tone: "gold",
      state: "needs_check",
