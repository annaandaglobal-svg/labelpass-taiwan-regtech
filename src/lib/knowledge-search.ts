...
const sourceTagExpansions: Record<string, string[]> = {
  ...
  "fermented-ingredient": ["fermented ingredient", "fermentation product", "culture powder", "strain identity"],
  "food-ingredients": ["food ingredient", "ingredient query", "ingredient safety", "scientific name", "usage limit"],
  "ingredient-safety": ["food ingredient safety", "usage limit", "caution", "scientific name"],
  "query-platform": ["official query", "ingredient query platform", "lookup database"],
