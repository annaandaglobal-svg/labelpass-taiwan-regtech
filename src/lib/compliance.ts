...
import type { AiIngredientVerdict } from "./ai-ingredient-fallback";
...
const verdictSurfacedCategories = new Set([
  ...
  "banned_drug_ingredient",
  "nutrient_upper_limit",
  "capsule_tablet_food",
  ...
  "commodity_labeling",
  "alcohol_tobacco_licence",
  "energy_efficiency_label",
  "environmental_agent_pesticide",
  "cites_endangered",
  "toy_inspection",
  "infant_formula_permit",
  "infant_formula_marketing",
  ...
  "electrical_bsmi_ncc",
  "import_document_legalization",
  "alcohol_import_regime",
  "commodity_tax_beverage",
  "food_raw_material_eligibility",
  "supplement_ingredient_drug",
  "cbd_cannabis_ban",
  "irradiated_food",
  "food_contact_pvc_ban",
  "food_contact_migration",
  "infant_article_material",
  "food_contact_labeling",
  "vet_drug_residue",
  "industrial_dye_adulterant",
  "plasticizer_food",
  "illegal_processing_agent",
  "additive_food_restriction",
  "additive_combined_limit",
  "net_content_metrology",
  "nutrient_content_claim",
  "cosmetic_drug_boundary",
  "cosmetic_microbiology",
  "cosmetic_claim_medical",
  "cosmetic_ingredient_2027",
  ...
  "chocolate_naming",
  "juice_naming",
  "food_process_contaminant",
  "medical_device_import",
  "tobacco_vape",
  "pet_food",
  "disinfectant_classification",
  "cosmetic_oral_care",
  "cosmetic_restricted_active",
  "food_additive",
